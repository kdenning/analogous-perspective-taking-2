...
```{r}
mod_orderonly_lib <- lmer(target_bfi_value ~ self_c*condition_order + (self_c |sub_id), data = lib_only)

#anova(model_base, mod_vartest_order)

tab_model(mod_orderonly_lib,
          digits = 3)

```

Effect of target order is marginal
